...
class updatetablestructureCommand(sublime_plugin.TextCommand):
    def run(self,edit):
    ...
    def createScriptFile(self,user_input):
        ...
        for sel in self.view.sel():
            self.table = self.view.substr(sel)
            f.write('UPDATE STRUCTURE COLMERGEOPTION RECENT FOR WHTABLE "'+self.table+'" FOR PROJECT "'+Project+'";')
